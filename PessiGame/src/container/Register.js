import { Image, Pressable, StyleSheet, Text, TextInput, View, TouchableOpacity, SafeAreaView } from 'react-native'
        ...
        <View style={styles.container}>
            <SafeAreaView>
                ...
                <View style={[styles.viewText, { marginTop: -11 }]}>
                    ...
                    <TextInput style={[styles.input]} placeholder="Số điện thoại" keyboardType='numeric' onChangeText={()=>setOtp(!isOtp)}></TextInput>
                    
                    <TextInput style={[styles.input, { marginTop: 0 }]} placeholder="Tên người dùng" onChangeText={() => setOtp(!isOtp)}></TextInput>
                ...
                <View style={{ lineHeight: 20, marginTop: 70, alignItems: 'center' }}>
                    ...
                    {isOtp ? (<Pressable onPress={() => navigation.navigate('Otp',{isOtp})} >
